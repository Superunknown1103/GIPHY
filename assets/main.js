$(document).ready(function(){ 
	...
	var gifArray = ['Homer Simpson','Bart Simpson','Lisa Simpson','Moe Syzslak','Cheif Wiggum','Carl Carlson','Mr. Burns'];
	...
	$('#searchButton').on('click', function(){
		...
		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + gifSearch + "&api_key=dc6zaTOxFJmzC&limit=5";
